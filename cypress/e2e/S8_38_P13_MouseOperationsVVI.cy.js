...
describe("Mouse Operations", () => {
  ...
  it('MouseOver: with trigger("mouseover")', () => {
    cy.viewport('macbook-16')//set screen size to macbook-16
  ...
  it('Right click: trigger("contextmenu")/rightclick()', () => {
  ...
  it('Double click": trigger("dblclick")/dblclick()', () => {
  ...
  it.skip('Drag and Drop using plugin : drag("#box106", { force: true })', () => {
  ...
  it('Scrolling Page : scrollIntoView({ duration: 2000 })', () => {
